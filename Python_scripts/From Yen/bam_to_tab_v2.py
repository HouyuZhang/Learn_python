...
def process_file(fname,samfile,outfile,tmpfile):
    ...
    list_all = {}
    out = open(outfile,"w")
    os.system(" bamToBed -i "+fname+" >"+samfile)
...
usage = '''
This script have been added several to recognize PE reads automatically and only the read_1 information will be used.
input_paths may be:
- a directory only.
